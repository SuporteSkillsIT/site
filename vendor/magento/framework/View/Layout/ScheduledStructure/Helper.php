        ...
        if ($parentName) {
            ...
            if ($structure->hasElement($parentName)) {
                ...
                if ($this->state->getMode() === State::MODE_DEVELOPER) {
                	# 2020-09-10 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
					# «Broken reference: the 'amasty.finder.5' element cannot be added as child to 'content',
					# because the latter doesn't exist»: https://github.com/dxmoto/site/issues/53
                	df_log_l($this, [
                		'message' => "Broken reference: the '{$name}' element cannot be added as child to '{$parentName}', " .
