<?php
# 2020-08-05 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
# 1) "A watermark is shown with a wrong transparency on the frontend product pages in Magento 2.3.5":
# https://github.com/dxmoto/site/issues/33
# 2) I have restored the file to its 2.2.3 version: https://github.com/dxmoto/site/issues/33#issuecomment-669010678
# 3) In future, I could need to implement another patch:
# https://github.com/dxmoto/site/blob/2020-08-04/vendor/magento/framework/Image/Adapter/Gd2.php#L100-L103
# to fix the issue "«Wrong file» on opening any frontend product page in Windows": https://github.com/dxmoto/site/issues/26
/**
