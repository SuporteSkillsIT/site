...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->getSelect()->columns(new \Zend_Db_Expr('(pop_price_base - (pop_price_base / 100 * pop_discount_percent)) as pop_price_with_discount_base'));
        return $this;
    }

    public function addBuyingPriceWithCosts()
    {
        $this->getSelect()->columns(new \Zend_Db_Expr('(pop_price_base - (pop_price_base / 100 * pop_discount_percent) + pop_extended_cost_base) as pop_price_with_cost_base'));
        return $this;
    }
    ...
    {
        $this->getSelect()->columns(array(new \Zend_Db_Expr('(pop_price / pop_qty_pack) as unit_price'),new \Zend_Db_Expr('(pop_price_base / pop_qty_pack) as unit_price_base')));
        return $this;
    }
