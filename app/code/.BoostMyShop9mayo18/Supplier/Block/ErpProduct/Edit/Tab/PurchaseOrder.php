...
class PurchaseOrder extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        $collection = $this->_orderProductCollectionFactory->create()->getOrdersHistory($this->getProduct()->getId())->addRealEta()->addBuyingPriceWithCosts()->addUnitPrices()->addBuyingPriceWithDiscount();
