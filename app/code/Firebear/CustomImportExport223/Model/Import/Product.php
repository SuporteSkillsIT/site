...
class Product extends MagentoProduct
{
     ...
     * @param ConditionFactory $priceRuleConditionFactory
    ...
    public function __construct(
        ...
        ConditionFactory $priceRuleConditionFactory,
        ...
        MediaVideoGallery $mediaProcessor = null,
        array $data = [],
        array $integrations = [],
        array $dateAttrCodes = [],
    ...
    protected function processMediaGalleryRows(&$rowData, &$mediaGallery, &$existingImages, &$uploadedImages, $rowNum)
    {
        ...
        foreach ($rowImages as $column => $columnImages) {
            foreach ($columnImages as $position => $columnImage) {
                [$isAlreadyUploaded, $alreadyUploadedFile] = $this
