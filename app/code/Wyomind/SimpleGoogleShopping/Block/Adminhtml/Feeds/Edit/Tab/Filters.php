...
class Filters extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Magento\Eav\Api\AttributeSetRepositoryInterface|null
     */
    ...
    /**
     * @var \Magento\Catalog\Model\ProductTypes\ConfigInterface|null
     */
    protected $productTypeConfig = null;
                ...
                if (isset($attribute['attribute_id'])) {
                    ...
                    foreach ($attributeOptions as $attributeOption) {
                        if (!empty($attributeOption['value'])) {
                            $options[] = [
                                'value' => (isset($attributeOption['option_id'])) ? $attributeOption['option_id'] : $attributeOption['value'],
                                'label' => isset($attributeOption['label']) ? $attributeOption['label'] : $attributeOption['value']
                            ];
                        }
                    }
