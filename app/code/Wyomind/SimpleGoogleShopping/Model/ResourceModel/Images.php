...
class Images extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        if (version_compare($this->licenseHelper->getMagentoVersion(), "2.1.0") == -1) { // Mage version < 2.1.0
        ...
        $select->distinct('value')
            ...
            ->where("value<>TRIM('') AND(store_id=" . $this->_storeId . " OR  store_id=0) AND cpemgv.disabled=0")
