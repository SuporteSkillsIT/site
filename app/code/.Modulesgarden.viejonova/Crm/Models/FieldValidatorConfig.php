...
class FieldValidatorConfig extends AbstractModel
{
    public $timestamps = false;

    protected $table = 'crm_fields_validators';

    protected $guarded = array('id');

    protected $fillable = array('field_id', 'type', 'value', 'error');
    ...
    {
        return (!empty($value) ? $value : 'Field is Required!');
    }
