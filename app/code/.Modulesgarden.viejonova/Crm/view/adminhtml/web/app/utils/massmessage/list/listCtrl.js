...
function( $rootScope,   $scope,   $translate,   $http,   blockUI,   isAllowed,   ngDialog)
{
    ...
    $scope.triggerDelete = function(id)
    {
        ...
        $scope.confirmDeleteDialog = ngDialog.openConfirm({
            template:'\
                <h2>Are you sure you want to delete this Mass Message configuration ?</h2>\
                <div class="ngdialog-buttons text-center">\
            ...
            // come on give me data from backend
            $http.delete($rootScope.settings.config.apiURL + '/massmessages/delete/'+ id +'/json', {
                cache: false,
                isArray: true
            }).then(function(result) 
            {
                ...
                $scope.scopeMessages.push({
                    type:    'success',
                    title:   "Success!",
                    content:  'Mass Message configuration has been deleted',
                });
