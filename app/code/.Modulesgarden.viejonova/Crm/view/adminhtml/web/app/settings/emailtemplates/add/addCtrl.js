...
function( $rootScope,   $scope,   $stateParams,   ngDialog,   $q,   blockUI,   $state,   $translate,   $http,   ngDialog)
{
    ...
    $scope.addEmailTemplatesFormSubmit = function()
    {
        ...
        // send query
        res = $http.put($rootScope.settings.config.apiURL + '/emailtemplates/create/json', params);
        ...
        res.then(function(response) {
            ...
            if(response.data.msg == 'Email template name already exist.') {
            ...
            $state.go('settings.emailtemplates.list');
        }
            return;
