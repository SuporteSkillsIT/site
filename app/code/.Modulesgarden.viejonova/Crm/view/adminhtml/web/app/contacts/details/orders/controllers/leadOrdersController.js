...
angular.module("mgCRMapp").controller(
        ...
        ['$scope', '$rootScope', '$state', '$stateParams', 'blockUI', '$http', 'leadMainDetailsData',
            function ($scope, $rootScope, $state, $stateParams, blockUI, $http, leadMainDetailsData)
            {
                ...
                $scope.rawData = [];
                $scope.displayed = [];
                $scope.createOrderUrl = $rootScope.settings.config.createOrderUrl;
                $scope.viewOrderUrl = $rootScope.settings.config.viewOrderUrl;
                $scope.invoiceUrl = $rootScope.settings.config.viewInvoiceUrl;
